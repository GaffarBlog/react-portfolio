...
export default function ButtonTab({ setActiveFilter, activeFilter }) {
   ...
   const tabs = ["All", "React", "Vue", "Angular"];
      ...
      <>
         ...
         {tabs.map(tab => (
            <button
               ...
               className={`px-4 py-1 rounded-full font-medium transition-colors !rounded-button whitespace-nowrap cursor-pointer hover:text-white w-[100px] z-10 ${
