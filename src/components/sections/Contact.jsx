            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
               <div className={`rounded-xl p-8 glass-md shadow-primary`}>
                  ...
                  <form>
                     ...
                     <button
                        type='submit'
                        className='w-full bg-primary text-white px-6 py-3 rounded-md font-medium hover:bg-primary/90 transition-colors !rounded-button whitespace-nowrap cursor-pointer'
                     >
                        Send Message
                     </button>
                  </form>
