         ...
         <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center'>
               <div className=''>
                  ...
                  <p className='text-lg md:text-md mb-8 text-slate-500 max-w-lg'>
                     From clean, easy-to-use designs to strong and reliable backends — I build complete websites that
